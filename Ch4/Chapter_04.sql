...
FROM 'C:\practical-sql-main\Chapter_04\us_counties_2010.csv'
...
FROM 'C:\practical-sql-main\Chapter_04\supervisor_salaries.csv'
WITH (FORMAT CSV, HEADER);
...
COPY us_counties_2010
TO 'C:\practical-sql-main\Chapter_04\us_counties_export.txt'
...
TO 'C:\practical-sql-main\Chapter_04\us_counties_mill_export.txt'
WITH (FORMAT CSV, HEADER, DELIMITER '|');
...
-- No, it won't. because you won't be able to create a column with that
-- data type and the precision must be larger than the scale. The correct
